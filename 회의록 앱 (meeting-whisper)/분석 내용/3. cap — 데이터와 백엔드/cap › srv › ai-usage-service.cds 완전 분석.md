# ai-usage-service.cds 완전 분석

> 소스: `cap/srv/ai-usage-service.cds`  
> 역할: 관리자에게 AI Core 호출 기록을 읽기 전용으로 노출한다.

## 1. 이 파일이 있는 이유

관리자에게 AI Core 호출 기록을 읽기 전용으로 노출한다.
...
| 항목 | 값 |
|---|---|
| 경로 | `cap/srv/ai-usage-service.cds` |
| 형식 | `cds` |
| 전체 줄 수 | 8 |
| 주석 줄 수 | 0 |
| 주요 심볼 수 | 2 |
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `AiUsageLogService` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
