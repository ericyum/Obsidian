...
> 소스: `deploy/OPERATIONS.md`  
> 역할: 배포, 역할 부여, secret rotation, rollback, 장애 triage를 다루는 운영 runbook이다.

## 1. 이 파일이 있는 이유

배포, 역할 부여, secret rotation, rollback, 장애 triage를 다루는 운영 runbook이다.
