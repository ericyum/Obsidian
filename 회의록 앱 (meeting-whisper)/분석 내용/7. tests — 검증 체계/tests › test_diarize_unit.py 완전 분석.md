# test_diarize_unit.py 완전 분석

> 소스: `tests/test_diarize_unit.py`  
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `test_diarize_uses_token_and_model_name` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |

## 7. 코드 흐름 상세

### 7.1 `test_diarize_uses_token_and_model_name`
