# test_summarize.py 완전 분석

> 소스: `tests/test_summarize.py`  
...
| `test_summarize_parses_json_into_note` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
...
### 7.3 `test_summarize_parses_json_into_note`
