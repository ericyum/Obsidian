# test_summarize_fenced.py 완전 분석

> 소스: `tests/test_summarize_fenced.py`  
...
| 항목 | 값 |
|---|---|
| 경로 | `tests/test_summarize_fenced.py` |
| 형식 | `python` |
| 전체 줄 수 | 32 |
| 주석 줄 수 | 0 |
| 주요 심볼 수 | 3 |
...
| `test_summarize_accepts_fenced_json` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
...
### 7.3 `test_summarize_accepts_fenced_json`
