# test_transcribe_slow.py 완전 분석

> 소스: `tests/test_transcribe_slow.py`  
...
| 항목 | 값 |
|---|---|
| 경로 | `tests/test_transcribe_slow.py` |
| 형식 | `python` |
| 전체 줄 수 | 14 |
| 주석 줄 수 | 0 |
| 주요 심볼 수 | 1 |
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `test_real_transcription` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |

## 7. 코드 흐름 상세

### 7.1 `test_real_transcription`
