...
> 소스: `legacy/fastapi/app/models.py`  
...
| 항목 | 값 |
|---|---|
| 경로 | `legacy/fastapi/app/models.py` |
| 형식 | `python` |
| 전체 줄 수 | 78 |
| 주석 줄 수 | 0 |
| 주요 심볼 수 | 8 |
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `Word` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `Segment` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `Transcript` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `ActionItem` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `Topic` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `MeetingNote` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `TranscriptReviewItem` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `Job` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
