# speaker_names.py 완전 분석

> 소스: `legacy/fastapi/app/speaker_names.py`  
...
| 항목 | 값 |
|---|---|
| 경로 | `legacy/fastapi/app/speaker_names.py` |
| 형식 | `python` |
| 전체 줄 수 | 26 |
| 주석 줄 수 | 1 |
| 주요 심볼 수 | 2 |
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `default_label` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `apply_speaker_names` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
