...
> 소스: `legacy/fastapi/app/storage.py`  
...
| 항목 | 값 |
|---|---|
| 경로 | `legacy/fastapi/app/storage.py` |
| 형식 | `python` |
| 전체 줄 수 | 28 |
| 주석 줄 수 | 0 |
| 주요 심볼 수 | 5 |
...
| 선언 | 읽을 때 확인할 점 |
|---|---|
| `_db_path` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `save_job` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `load_job` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `list_jobs` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
| `delete_job` | 입력, 상태 변경, 반환값과 실패 경로를 확인한다. |
